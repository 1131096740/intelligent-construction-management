...
| P0-3 真实使用体验 | [~] | 结算/付款业务选择器、真实首页工作台、待办/阻塞摘要已完成。 | 逐单 `GET /me/work-items`、复杂筛选器、小程序。 |
...
- [~] Web 管理端：企业后台、合同/结算/付款/资料库/审计、登录鉴权、委托台账、写操作入口和企业流程 UI P0 切片已完成；审批中心五视图、统一动作元数据、资料库行内授权下载仍待拆分。

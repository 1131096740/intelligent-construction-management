...
状态：`[~]`（2026-07-27；已完成生效阶段守恒、人工映射写入口、主任确认、提交门禁和页面首版；浏览器与完整拓扑验收待完成）

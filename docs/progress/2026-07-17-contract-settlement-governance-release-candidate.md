...
> 当前合并中间 SHA：`4eddaff67c5adf7b8d03da624e95b9a4615cd220`（不得作为最终发布授权目标）
> 已合并 `origin/main`：`d0007fe5b8a18dd2602a93d012634040eaf2183a`
> 生产当前已知运行 SHA：`6c382a39`；生产迁移：61 个
...
| 项目 | 结果 |
| --- | --- |
| 最新已合并 `origin/main` | `d0007fe5b8a18dd2602a93d012634040eaf2183a`，已合并 |
| 当前合并中间 SHA | `4eddaff67c5adf7b8d03da624e95b9a4615cd220`；后续还有文档收口提交，不能作为最终 SHA |
| 最终候选 SHA | 待填，必须是 Task 22 最终文档提交后的 40 位 SHA |
| 对 `origin/main` 提交列表 | 待最终候选固定后生成 |
| 对生产 `6c382a39…` 提交列表 | 待最终候选固定后生成 |
| 实际修改文件清单 | 待 `git diff --name-status 6c382a39…<candidate>` 生成 |
...
| 生产 61 个迁移事实 | 已知事实，待恢复演练复核 | 当前已知生产 SHA `6c382a39`、61 个迁移 |

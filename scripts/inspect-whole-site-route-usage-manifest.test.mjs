...
test("locks the repository baseline to 42 plus 19 external routes and no blockers", async () => {
  ...
  assert.equal(manifest.summary.routeCount, 435);
  ...
  assert.equal(manifest.summary.derivedProductionPageCount, 325);
  assert.equal(manifest.summary.pageRouteCount, 328);

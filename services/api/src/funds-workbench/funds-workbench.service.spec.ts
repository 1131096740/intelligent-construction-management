...
describe("FundsWorkbenchService", () => {
  ...
  it("projects only visible contract and spot payments while retaining non-project expense funds", async () => {
    findMany
      ...
      .mockResolvedValueOnce([
        { id: "expense-1", code: "BX-001", claimType: "reimbursement", status: "approved_pending_payment", projectId: null, reason: "差旅", companyEntityNameSnapshot: "建工", payeeNameSnapshot: "张三", requestedAmountCents: 12000n, companyPayableAmountCents: 8000n, fundedAmountCents: 0n, updatedAt: new Date("2026-07-23T12:00:00.000Z") },
        { id: "loan-1", code: "JK-001", claimType: "loan", status: "disbursed", projectId: "project-1", reason: "现场周转", companyEntityNameSnapshot: "建工", payeeNameSnapshot: "李四", requestedAmountCents: 3000n, companyPayableAmountCents: 0n, fundedAmountCents: 3000n, updatedAt: new Date("2026-07-23T13:00:00.000Z") },
        { id: "draft-1", code: "BX-DRAFT", claimType: "reimbursement", status: "draft", projectId: "project-1", reason: "草稿", companyEntityNameSnapshot: "建工", payeeNameSnapshot: null, requestedAmountCents: 100n, companyPayableAmountCents: 100n, fundedAmountCents: 0n, updatedAt: new Date("2026-07-23T14:00:00.000Z") }
      ]);
    ...
    expect(result.items).toEqual([
      ...
      expect.objectContaining({ code: "BX-001", source: "expense_reimbursement", requestedAmountCents: "8000", payeeName: "张三", project: null }),
  ...
  it("filters pending funds by source and rejects unknown query values", async () => {
    findMany
      ...
      .mockResolvedValueOnce([
        { id: "expense-1", code: "BX-001", claimType: "reimbursement", status: "approved_pending_payment", projectId: null, reason: "差旅", companyEntityNameSnapshot: "建工", payeeNameSnapshot: "张三", requestedAmountCents: 12000n, companyPayableAmountCents: 8000n, fundedAmountCents: 0n, updatedAt: new Date("2026-07-23T12:00:00.000Z") },
        { id: "loan-1", code: "JK-001", claimType: "loan", status: "disbursed", projectId: null, reason: "现场周转", companyEntityNameSnapshot: "建工", payeeNameSnapshot: "李四", requestedAmountCents: 3000n, companyPayableAmountCents: 0n, fundedAmountCents: 3000n, updatedAt: new Date("2026-07-23T13:00:00.000Z") }
      ]);

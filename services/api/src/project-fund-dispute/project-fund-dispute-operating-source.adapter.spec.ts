import { ProjectFundDisputeOperatingSourceAdapter } from "./project-fund-dispute-operating-source.adapter";

describe("ProjectFundDisputeOperatingSourceAdapter", () => {
  ...
  it("maps release as a decrease and technical reversal as an exact reversal", () => {
    ...
    expect(adapter.toOperatingFactInput(base).input.impacts[0]).toEqual(expect.objectContaining({
      impactKind: "project_disputed_funds_decrease",
      direction: "decrease"
    }));

...
export const NON_RECEIPT_FILE_BINDINGS = [
  ...
  {
    table: "PaymentExecutionPayerAttestation",
    columns: ["verificationEvidenceFileId", "proxyAuthorizationEvidenceFileId"]
  },
  {
  ...
  },
  {
    ...
    columns: ["attachmentFileId", "terminationSignatureFileId"]
  },
  {

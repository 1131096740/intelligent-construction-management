...
const chromiumMockCoverage = new RegExp(
  `${settlementMockCoverage.source}|core detail pages expose flow summaries|结算详情展示双证据|separates the payment ledger|P0 desktop Chromium|P0 mobile WebKit`,
  "u"
);
const webkitMockCoverage = new RegExp(
  `${settlementMockCoverage.source}|RC-06 mocked contract detail|本人可在设置页|资料库只在服务端授权后`,
  "u"
);

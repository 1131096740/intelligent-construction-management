...
import { downloadApprovalForm, fetchCompanyEntities, uploadPrivateFile, type CompanyEntityReadModel } from "../../api/core-flow-read.api";
...
const companies = ref<CompanyEntityReadModel[]>([]);
...
async function loadCompanies() {
  try {
    companies.value = await fetchCompanyEntities();

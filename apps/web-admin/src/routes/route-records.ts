...
export const fundExecutionRoleKeys = [
  "finance_staff",
  "finance_director",
  "chairman",
  "general_manager"
  ...
  },
  {
    ...
    items: [
      { label: "资金办理工作台", path: "/统一资金办理工作台", requiredRoleKeys: fundsWorkbenchRoleKeys },
      {
        label: "资金执行案件",
        path: "/资金执行案件",
        requiredGlobalRoleKeys: fundExecutionRoleKeys
      },
      {
        label: "资金移动工作台",
        path: "/资金移动工作台",
...
export const webAdminRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "资金执行案件",
        component: () => import("../pages/fund-executions/FundExecutionWorkbenchPage.vue"),
        meta: { requiredGlobalRoleKeys: fundExecutionRoleKeys, title: "资金执行案件" }
      },
      {
        path: "工资应付核销工作台",

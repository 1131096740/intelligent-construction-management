...
export const BUSINESS_ACTIONS = [
  ...
  "project.upstream_fund_fact.record",
  "project.upstream_fund_fact.confirm",
  "project.affiliate_contract_fact.record",
  "project.affiliate_contract_fact.confirm",
  "project.affiliate_settlement_fact.record",
  "project.affiliate_settlement_fact.confirm",
  ...
  "wage_statement.prepare",
  "wage_statement.submit",
  "wage_statement.confirm",
  "wage_statement.return",
  "wage_sensitive_read",
  "wage_sensitive_download",
  "wage_sensitive_export",
  "operating_takeover.manage",
  "operating_takeover.confirm",
  "operating_takeover.activate",
  "operating_takeover.file.upload",
  "payment.create",
  "payment.approve",
  "payment.execution",
...
export const ACTION_REQUIRED_ROLES: Record<BusinessAction, readonly RoleKey[]> = {
  ...
  "contract.archive.final.upload": ["contract_staff", "contract_director"],
  ...
  "project.upstream_fund_fact.record": ["finance_staff", "finance_director"],
  "project.upstream_fund_fact.confirm": ["finance_staff", "finance_director"],
  "project.affiliate_contract_fact.record": ["contract_staff"],
  "project.affiliate_contract_fact.confirm": ["contract_director"],
  "project.affiliate_settlement_fact.record": ["budget_staff"],
  "project.affiliate_settlement_fact.confirm": ["budget_staff"],
  "project.affiliate_payment_fact.record": ["finance_staff", "finance_director"],
  "project.affiliate_payment_fact.confirm": ["finance_staff", "finance_director"],
  "project.affiliate_business_fact.evidence_supplement": [
    "contract_staff",
    "contract_director",
    "budget_staff",
  ...
  "necessary_expense_reserve.prepare": ["finance_staff", "finance_director"],
  "necessary_expense_reserve.submit": ["finance_staff", "finance_director"],
  ...
  "clearing.attest": ["finance_staff", "finance_director"],
  "clearing.confirm": ["finance_director"],
  "clearing.return": ["finance_director"],
  "clearing.reopen": ["finance_director"],
  "clearing.reconciliation.reverse": ["finance_director"],
  "payable_settlement.read": ["finance_staff", "finance_director"],
  "payable_settlement.allocate": ["finance_staff", "finance_director"],
  "payable_settlement.submit": ["finance_staff", "finance_director"],
  "payable_settlement.confirm": ["finance_director"],
  "payable_settlement.return": ["finance_director"],
  "wage_statement.prepare": ["finance_staff", "finance_director"],
  "wage_statement.submit": ["finance_staff", "finance_director"],
  "wage_statement.confirm": ["finance_director"],
  "wage_statement.return": ["finance_director"],
  "wage_sensitive_read": ["finance_staff", "finance_director"],
  "wage_sensitive_download": ["finance_staff", "finance_director"],
  "wage_sensitive_export": ["finance_staff", "finance_director"],
  "operating_takeover.manage": [
    "contract_staff",
    "contract_director",
    "finance_staff",
  ...
  "operating_takeover.confirm": ["contract_director", "finance_director"],
  "operating_takeover.activate": ["contract_director", "finance_director"],
  "operating_takeover.file.upload": [
    "contract_staff",
    "contract_director",
    "finance_staff",
